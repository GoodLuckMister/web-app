...
const Welcome: React.FC<IWelcome> = ({ style }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', ...style }}>
            <FlexColumnCenter style={{ width: width / 4, margin: `0px ${width / 9}px 20px 100px` }}>
                ...
                <SubLargeText
                    ...
                    Top-Ipro ( independent professionals ) is a social recommendation engine that
                    empowers customers to choose the best remote{' '}
